...
% plds simulation 3: prediction accuracy study

% set seed for reproducibility
rng(100);

% calculate future data
load('p-300-d-10-T-100-data-regA-sparseC.mat');
T_future = 10;
...
% save results
save(['./p-',num2str(p),'-d-',num2str(d),'-T-',num2str(T),'-sim3-result.mat'],'p','d','T','penaltyA','penaltyC','accuracy','T_future');
